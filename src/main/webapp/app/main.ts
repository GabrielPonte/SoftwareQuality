...
new Vue({
  ...
  provide: {
    ...
    opcaoEscolhidaService: () => new OpcaoEscolhidaService(),
    postoSaudeService: () => new PostoSaudeService(),
    recebaEmailService: () => new RecebaEmailService(),
    tipoInformacaoService: () => new TipoInformacaoService(),
